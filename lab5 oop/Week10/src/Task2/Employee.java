...
public class Employee extends Person implements java.lang.Comparable<Object>{
	private double salary;
	private Date year;
	private String insuranceNumber;
	private double bonus;
	
	public Employee(String name, String surname, int age, String insuranceNumber, int salary, int bonus) {
